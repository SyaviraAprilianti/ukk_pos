    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div  style="display: flex; ">
          <h2 style="font-family:sans-serif; color:black;">Customers List</h2>
        ...
        <li><a class="dropdown-item" href="#">Import Customer</a></li>
        <li><a class="dropdown-item" href="#">Export Customer</a></li>
        </ul>
    </div>
</div>
        </div>
        ...
        <input type="text" class="form-control" placeholder="Name, email, phone" style="border-radius:15px; width:20%;">
