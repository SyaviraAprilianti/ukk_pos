        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div style="display: flex; align-items: center">
                    <h2 style="font-family:sans-serif; color:black;">Taxes</h2>
                    <button type="button" class="btn btn-primary " style="height:35px; margin-left: auto;"
                        data-toggle="modal" data-target="#modaladd">Create Taxes</button>
                </div>
                    ...
                    <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#modaledit"
                                                        class="btn btn-warning passingId" data-id={{$t->id}}
                                                        data-name={{$t->name}} data-amount={{$t->amount}}><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                    <a href="/taxes/hapus/{{ $t->id }}" class="btn btn-danger"><i
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Taxes</h5>
                                    </div>
                                    ...
                                    <form id="form-edit">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="name" id="nametax"
                                                        placeholder="Name">
                                                </div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="input-group">
                                                        <input type="number" min="1" max="100" class="form-control" name="amount" id="amounttax"
                                                        placeholder="Amount">
                        ...
                        <div class="modal fade" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Taxes</h5>
                                    </div>
                                    <!-- <form class="form-horizontal" action="/tambahmkn" method="post" enctype="multipart/form-data" role="form"> -->

                                    <form action="create/taxes" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <input type="hidden" name="id" id="id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="input-group">
                                                    <input type="number" min="1" max="100" class="form-control" name="amount" id="amount"
                                                        placeholder="Amount">
                                                         <span class="input-group-addon">%</span>
                                                </div>
                                                </div>
