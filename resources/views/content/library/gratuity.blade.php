        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div style="display: flex; align-items: center">
                    <h2 style="font-family:sans-serif; color:black;">Gratuity</h2>
                    <button type="button" class="btn btn-primary "
                        style="margin-left: auto; height:35px; margin-right:5px;" data-toggle="modal"
                        data-target="#modaladd">Create Gratuity</button>
                    ...
                    <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#modaledit"
                                                        class="btn btn-warning passingId" data-id={{$g->id}}
                                                        data-name="{{$g->name}}" data-amount="{{$g->amount}}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                    <a href="/gratuity/hapus/{{ $g->id }}" class="btn btn-danger"><i
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Gratuity</h5>
                                    </div>
                                    <!-- <form class="form-horizontal" action="/tambahmkn" method="post" enctype="multipart/form-data" role="form"> -->

                                    <form action="create/gratuity" method="post">
                                        {{ csrf_field() }}
                        ...
                        <div class="modal fade" id="modaledit" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Gratuity</h5>
                                    </div>
                                    <!-- <form class="form-horizontal" action="/tambahmkn" method="post" enctype="multipart/form-data" role="form"> -->
                                    ...
                                    <form id="form-edit">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <input type="hidden" name="id" id="idgrat">
                                                <label class="col-lg-2 col-sm-2 control-label">Name</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="name" id="nameg"
                                                        placeholder="Name">
                                                </div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="input-group">
                                                        <input type="number" min="1" max="100" class="form-control"
                                                            name="amount" id="amountg" placeholder="Amount">
                                                        <span class="input-group-addon">%</span>
                                                    </div>
                                                </div>
                                            </div>
