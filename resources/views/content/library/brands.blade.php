        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div style="display: flex; align-items: center">
                    <h2 style="font-family:sans-serif; color:black;">Brands</h2>
                    <button type="button" class="btn btn-primary "
                        style="margin-left: auto; height:35px; margin-right:5px;" data-toggle="modal"
                        data-target="#modaladd">Create Brand</button>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#modaledit"
                                                        class="btn btn-warning passingId" data-id={{$b->id}}
                                                        data-brand="{{$b->brands_name}}" data-item="{{$b->item_stocks}}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                    <a href="/brands/hapus/{{ $b->id }}" class="btn btn-danger"><i
                        ...
                        <div class="modal fade" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="create/brands" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <input type="hidden" name="id" id="id">
                                                <label class="col-lg-2 col-sm-2 control-label">Brand Name</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="brand" id="brand-name"
                                                        placeholder="Brand Name">
                                                </div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Item Stocks</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="item" id="item-stocks"
                                                        placeholder="Item Stocks">
                                                </div>
                                            </div>
                                            <br>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-primary" type="submit"> Save to All
                                                Outlets&nbsp;</button>
                                    ...
                                    <form id="form-edit">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <label class="col-lg-2 col-sm-2 control-label">Brand Name</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="brand" id="brandname"
                                                        placeholder="Brand Name">
                                                </div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Item Stocks</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="item" id="itemstocks"
                                                        placeholder="Item Stocks">
                                                </div>
                                            </div>
                                            <br>
