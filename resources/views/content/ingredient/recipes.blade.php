...
<div  style="display: flex; ">
    <h2 style="font-family:sans-serif; color:black;">Recipes</h2>
    <div class="row" style="margin-left:59%;">
        <a class="btn btn-default ng-binding" style="margin-top:20px;" ><!-- react-text: 3822 -->Total : <!-- /react-text --><!-- react-text: 3938 -->2<!-- /react-text --></a>
  ...
  <li><a class="dropdown-item" href="#">Import Recipes</a></li>
  <li><a class="dropdown-item" href="#">Export Recipes</a></li>
  </ul>
</div>
</div>
<button type="button" class="btn btn-primary " style=" margin-top:20px; height:35px;">Create Recipe</button>
  </div>
</div>
