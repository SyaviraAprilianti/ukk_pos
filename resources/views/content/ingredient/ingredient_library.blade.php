...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div  style="display: flex; ">
            <h2 style="font-family:sans-serif; color:black;">Ingredient Library</h2>
            <div class="row" style="margin-left:46%;">
                <a class="btn btn-default ng-binding" style="margin-top:20px;" ><!-- react-text: 3822 -->Total : <!-- /react-text --><!-- react-text: 3938 -->1<!-- /react-text --></a>
          ...
          <li><a class="dropdown-item" href="#">Import Ingredients</a></li>
          <li><a class="dropdown-item" href="#">Export Ingredients</a></li>
          </ul>
        </div>
        </div>
        <button type="button" class="btn btn-primary " style=" margin-top:20px; height:35px;">Create Ingredient</button>
          </div>
        </div>
    <br>
    ...
    <form class="form-inline">
        ...
        <select name="categoryId" class="form-control" id="filterSelectCategory" style="border-radius:15px;">
        ...
        <select name="categoryId" class="form-control" id="filterSelectCategory" style="border-radius:15px;">
            ...
            <option value="2">Low stock Alert</option>
            <option value="3">Out of Stock Alert</option>        
        </select>
