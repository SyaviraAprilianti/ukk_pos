  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        {{-- <h2 style="font-family:sans-serif; color:black;">Purchase Order (PO)</h2>

    <div class="tmb" style="margin-top:-43px; ">
        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group" style="margin-left:850px;">
                <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                Import/Export <span class="caret"></span>
                </button>
                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                <li><a class="dropdown-item" href="#">Import PO</a></li>
                <li><a class="dropdown-item" href="#">Export PO</a></li>
                </ul>
            </div>
        </div>
        <button type="button" class="btn btn-info">Create PO</button>
    </div>
    <br> --}}

    <div  style="display: flex; align-items: center">
        <h2 style="font-family:sans-serif; color:black;">Summary</h2>
        {{-- <button type="button" class="btn btn-primary " style="margin-left: auto; height:35px; margin-right:5px;">Export</button> --}}

  
        <button type="button" class="btn btn-primary " style="margin-left: auto; height:35px;">Export</button>
    </div>
    ...
    <form class="form-inline">
        ...
        <select name="categoryId" class="form-control" id="filterSelectCategory" >
          <option value="1" >Item Library</option>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="hidden-table-info">
                                    <thead>
                                        <tr>
