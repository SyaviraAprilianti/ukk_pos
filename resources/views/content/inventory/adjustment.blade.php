...
<div  style="display: flex; ">
    <h2 style="font-family:sans-serif; color:black;">Adjustment</h2>
  ...
  <li><a class="dropdown-item" href="#">Import Adjustment</a></li>
  <li><a class="dropdown-item" href="#">Export Adjustment</a></li>
  </ul>
</div>
</div>
<button type="button" class="btn btn-primary " style=" margin-top:20px; height:35px;">Create Adjustment</button>
  </div>
</div>
