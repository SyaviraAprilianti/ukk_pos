...
<body>
  <section id="container">
    ...
    <div  style="display: flex; ">
        <h2 style="font-family:sans-serif; color:black;">Purshase Order</h2>
    ...
    <button type="button" class="btn btn-primary " style=" margin-top:20px; height:35px;">Create PO</button>
      </div>
    </div>
